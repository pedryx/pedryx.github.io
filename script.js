...
` + lygiaLib + `
    ...
    const Octave octaves[octaveCount] = Octave[octaveCount](
        Octave( 1.0, 0.50),
        Octave( 2.0, 0.30),
        Octave( 4.0, 0.20),
        Octave( 8.0, 0.10),
    ...
    const Terrain terrains[terrainCount] = Terrain[terrainCount](
...
function createShader(gl, type, source) {
    ...
    if (!gl.getShaderParameter(shader, gl.COMPILE_STATUS)) {
        alert(type + "Shader compilation error: " + gl.getShaderInfoLog(shader));
        return;
    }
